  ...
  return (
    <>
      <section className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-copy">
            <div>
              <p>EZOrder turns every seat, kitchen station, and service moment into one beautifully coordinated experience—so remarkable service feels effortless.</p>
            ...
            <div className="live-board" aria-label="Live event overview">
              <div className="live-top"><span className="live-title">Aurora Gala · Live</span><span className="live-signal"><i className="signal-dot"/>All systems flowing</span></div>
              <div className="metric-grid">
                <div className="metric"><div className="metric-label">Guests served</div><div className="metric-value">428 <small>↑ 12%</small></div></div>
              ...
              <div className="order-stream">
                <div className="stream-row"><div className="table-orb">T12</div><div className="stream-main"><strong>Amara · Seat 4</strong><span>Jollof, citrus chicken · 2 items</span></div><span className="status">en route</span></div>
                <div className="stream-row"><div className="table-orb">T08</div><div className="stream-main"><strong>Table 8 · shared</strong><span>Starter course · 6 guests</span></div><span className="status amber">plating</span></div>
                <div className="stream-row"><div className="table-orb">T21</div><div className="stream-main"><strong>Daniel · Seat 2</strong><span>Allergy-safe meal verified</span></div><span className="status">ready</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-shell">
        ...
        <p className="section-lede">A living operational layer that understands every guest, every course, and every service promise—then helps your team deliver it.</p>
        <div className="bento">
          <article className="bento-card dark">
            <div className="bento-number">01 · SERVICE BRAIN</div><div className="orbit"/>
          ...
          <article className="bento-card">
            <div className="bento-number">02 · ROOM PULSE</div>
          ...
          <article className="bento-card full">
            <div className="bento-number">03 · ONE CONTINUOUS JOURNEY</div>
      ...
      <footer className="footer"><span>© 2026 EZOrder · Hospitality, orchestrated.</span><span>Designed for remarkable service.</span></footer>
    </>
  );
}
